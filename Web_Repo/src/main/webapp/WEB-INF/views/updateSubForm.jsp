            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Edit Department's Function Details</h3>
                        <p>Fill in the data below.</p>
    <div align="center">
	<form:form action="processSubUpdate" method="post" modelAttribute="subfunctionPOJO">
		...
		<form:input class="form-control"  type="url" path="url" placeholder="Add url"  /> <br>
		<form:errors path="url" cssClass="errors"/>
		
		<form:input type="text" path="category" class="notvisible"/>
		</div>
