...
<!-- _______________________________________NAVBAR________________________________________________ -->
    ...
    <div align="center">
	<form:form action="changeadminPass">
		...
		<input class="form-input" type="password" placeholder="Old Password"  name="pass" required>
		
		<label for="newpassword"> <strong> New Password </strong> </label>
		<input class="form-input" type="password" placeholder="New Password" name="passnew" required>
		</div>
		
		 <div class="form-button mt-3">
         <input id="submit" class="btn btn-primary" type="submit" value="Change Password">
         </div>
