...
<!-- _______________________________________NAVBAR________________________________________________ -->
    ...
    <div align="center">
	<form:form method="post" action="addMainFunction"  modelAttribute="functionPOJO" >

		<div class="col-md-12">
		<label for="title"> <strong>Department Name</strong></label>
		<form:input class="form-control" type="text" path="title"  placeholder="Add Department"/> <br>
		<form:errors path="title" cssClass="errors"/> <br>
		
		<label for="description"> <strong> Department Description </strong> </label>
		<form:textarea class="form-control" type="text" path="description" placeholder="Add Description" /> <br>
